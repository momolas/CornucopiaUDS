...
public extension UDS {
    ...
    enum ISOTP {
        ...
        public static var MaximumFrameSize: Int = 4095
        /// UDS data transfers have two control bytes (0x36 #BLOCK) before the block payload comes
        public static var MaximumDataTransferSize: Int = MaximumFrameSize - 2
    }
}
...
public extension UDS.ISOTP {
    ...
    final class Encoder: UDS.BusProtocolEncoder {
        ...
        public func encode(_ bytes: [UInt8]) throws -> [UInt8] {
            ...
            guard bytes.count < 4095 else { throw UDS.Error.encoderError(string: "Message too long. Maximum ISOTP payload is 4095 (0xFFF) bytes") }
